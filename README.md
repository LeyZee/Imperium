<p align="center">
  <img src="imperium/frontend/public/favicon.svg" alt="Imperium" width="80" height="80" />
</p>
...
> **Le code source se trouve dans le dossier [`imperium/`](./imperium)**
...
```bash
# Backend (Jest)
cd imperium/backend && npm test

# Frontend (Vitest + React Testing Library)
cd imperium/frontend && npm test
```
...
```bash
# Build frontend
cd imperium/frontend && npm run build
